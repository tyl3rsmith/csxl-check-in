...
class StorageService:
    ...
    def delete_user(self, pid: int) -> None:
        """Deletes a user and their associated checkins from the system.
        
        Args:
            pid of the user to be deleted.
        ...
        if pid in _registrations:
            for checkin in _checkins:
                if checkin.user.pid == pid:
                    invalid_checkins.append(checkin)

            for checkin in invalid_checkins:
